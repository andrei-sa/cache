...
namespace
{
  ...
  class UniqueLockBasedItemFixture : protected LockBasedItem<float>
                                   , public ::testing::Test
  {
  public:
    UniqueLockBasedItemFixture()
      : LockBasedItem<float>(0.f, true)
    {
    }
  };

  TEST_F(UniqueLockBasedItemFixture, UpdateAndReadST)
  {
    EXPECT_EQ(0.f, read());
    EXPECT_EQ(0.f, read());
  ...
  TEST_F(UniqueLockBasedItemFixture, SingleValueMT)
  {
    update(1.f);
  ...
  TEST_F(UniqueLockBasedItemFixture, TwoValuesMT)
  {
    update(1.f);
  ...
  TEST_F(UniqueLockBasedItemFixture, DictionaryMT)
  {
