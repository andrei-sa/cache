...
namespace
{
  ...
  class SharedLockBasedItemFixture : protected LockBasedItem<float>
                                   , public ::testing::Test
  {
  public:
    SharedLockBasedItemFixture()
      : LockBasedItem<float>(0.f, false)
    {
    }
  };

  TEST_F(SharedLockBasedItemFixture, UpdateAndReadST)
  {
    EXPECT_EQ(0.f, read());
    EXPECT_EQ(0.f, read());
  ...
  TEST_F(SharedLockBasedItemFixture, SingleValueMT)
  {
    update(1.f);
  ...
  TEST_F(SharedLockBasedItemFixture, TwoValuesMT)
  {
    update(1.f);
  ...
  TEST_F(SharedLockBasedItemFixture, DictionaryMT)
  {
